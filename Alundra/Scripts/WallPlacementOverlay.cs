...
public static class WallPlacementOverlay
{
    ...
    /// the original's finer <c>depthSortValue &amp; 0xffff</c> tiebreak is a screen-projected z, which this 2D
    ...
    /// </summary>
    internal static int ComputeEntityElevation(int posY)
    {
        return (posY >> 20) * RowStride + EntityDepthSlot;
    }
    ...
    /// </summary>
    public static void ApplyEntitySortKey(DepthSortable2DComponent depthSortable, int posY)
    {
        depthSortable.Elevation = ComputeEntityElevation(posY);
    }
}
