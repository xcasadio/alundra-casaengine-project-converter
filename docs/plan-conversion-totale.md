...
- **Découpage** (plan détaillé : `docs/plan-e13-hud.md`) :
  ...
  - **E13.d — La gestion de l'inventaire : inventaire principal ✅ validé en jeu le 2026-09-24 (D6) ; sous-inventaire et bascule L1/R1 🧪, livrés et vérifiés le 2026-09-25 (`docs/plan-e13d-sous-inventaire.md`, SI1 à SI5), recette de l'auteur à faire (SI6)** (approuvée le 2026-09-21) : plan
...
| E13.d inventaire principal (puis sous-inventaire et L1/R1) | principal ✅ validé en jeu le 2026-09-24 ; sous-inventaire et L1/R1 🧪 (livrés et vérifiés le 2026-09-25, recette de l'auteur à faire) | `docs/plan-e13d-inventaire.md` ; `docs/plan-e13d-sous-inventaire.md` : analyseur `8f403d5`, parent `45bb0e2`, `a3901af`, `dc3fe1a`, `5f12e53` |
| E14 IA native | ⏳ | |
