...
### ✅ PI9 — Recette par capture, prédite avant d'être prise — faite le 2026-09-26
...
**Relecture de clôture (vérificateur frais, `6b03234`) : CONFIRMED.**
- Le commit ne change que des commentaires dans les deux XAML, et le plan.
- Aucun texte ne peut recouvrir une icône au repos, dans l'un ou l'autre écran :
  - les noms commencent à x ≥ 193 et les descriptions à y ≥ 181, alors que toute icône finit à x ≤ 168 et y ≤ 164 ;
  - `font3` : hauteur de ligne 16, aucun décalage de glyphe.
- 31 des 88 icônes recouvrent des pixels du cadre, ce qu'il a retrouvé.
- **Remarque P3, reportée à la recette** : quand les herbes sont équipées (case 6), leur chiffre de compte (entrée 5)
...
par-dessus. De même, quand les herbes sont équipées, leur chiffre de compte recouvre le coin inférieur droit du cadre.
